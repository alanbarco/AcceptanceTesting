...
def step_then_system_should_apply_discount_to_total_cost(context, discount):
    ...
    actual_discount = dining.calc_qty_discount(context.client_order, base_total_cost) / base_total_cost
...
def step_then_system_should_calculate_total_cost(context, total_cost):
    ...
    actual_total_cost = dining.calc_meal_total_cost("Pizza familiar", context.meal_quantity)
